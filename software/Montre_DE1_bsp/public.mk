...
SOPCINFO_FILE := C:/Users/hamza/Desktop/Montre-DE1/montre_de1.sopcinfo
...
# Design Name 
# setting SOPC_NAME is montre_de1
SOPC_NAME := montre_de1
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001060
SOPC_SYSID_FLAG += --sidp=0x1001060
ELF_PATCH_FLAG  += --sidp 0x1001060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1684023273
SOPC_SYSID_FLAG += --timestamp=1684023273
ELF_PATCH_FLAG  += --timestamp 1684023273
